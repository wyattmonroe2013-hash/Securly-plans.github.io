...
window.GoldAuth = (() => {
  ...
  const ACCOUNT_HISTORY_KEY = "gold1g_account_history_1s";
  ...
  async function findCloudUser(username) {
    ...
    // Gold 1S compatible with both layouts.
    for (const collectionName of collections) {
