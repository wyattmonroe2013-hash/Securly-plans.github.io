"use strict";
(function EmeraldOSGold1UUserIsolation(){
  if(window.Gold1UUserIsolation)return;
  ...
  window.Gold1UUserIsolation={switchToUser,snapshotActiveSession,sealLocalSession,clearActiveData:clear,status,privateKey};
})();
