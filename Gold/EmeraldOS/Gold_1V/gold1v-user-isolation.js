"use strict";
(function EmeraldOSGold1VUserIsolation(){
  if(window.Gold1VUserIsolation)return;
  ...
  function privateKey(key){return (legacyExact.has(key)||/^gold1[a-v]_/.test(key))&&!excluded.test(key)}
  ...
  window.Gold1VUserIsolation={switchToUser,snapshotActiveSession,sealLocalSession,clearActiveData:clear,status,privateKey};
})();
