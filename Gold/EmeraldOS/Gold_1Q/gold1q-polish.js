...
(function EmeraldOSGold1QPolish(){
  ...
  function patchAPI(){
    ...
    if(originalSave&&!window.Gold1Q.__gold1pSessionSavePatched){window.Gold1Q.__gold1pSessionSavePatched=true;window.Gold1Q.saveWorkspaceNow=async show=>{captureSessionState();return originalSave(show)}}
