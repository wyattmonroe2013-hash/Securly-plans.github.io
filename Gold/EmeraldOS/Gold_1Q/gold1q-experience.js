...
(function EmeraldOSGold1QExperience(){
  ...
  function patchAPI(){Object.assign(window.Gold1Q||{}, {openCalendar:openInteractiveCalendar,openAccountHistory:openHistory,changePassword,openGameCenter,openPasswordChange:changePassword,gameData,calendarEvents,recordAccountEvent:record});window.Gold1Q=window.Gold1Q||api()}
  function init(){
