...
/* EmeraldOS Gold 1R cloud continuity and migration gate.
   ...
   Gold 1R to save over the shared VM. This module never writes the shared
   system/emeraldGoldLatest release pointer. */
(function EmeraldOSGold1RContinuity(){
  if(window.__EMERALDOS_GOLD_1R_CONTINUITY__)return;
  window.__EMERALDOS_GOLD_1R_CONTINUITY__=true;

  const VERSION="1R",PREFIX="gold1g_",REPORT_KEY=PREFIX+"migration_1r_cloud_report";
  ...
  const write=(key,value)=>{try{localStorage.setItem(key,JSON.stringify(value));return true}catch(error){console.warn("Gold 1R continuity local write failed",key,error);return false}};
  const helper=()=>window.Gold1RLocalMigration||{};
  ...
  const categoryAliases={
    registry_1h:"registry_1r",registry_1i:"registry_1r",registry_1j:"registry_1r",registry_1k:"registry_1r",registry_1l:"registry_1r",registry_1m:"registry_1r",registry_1n:"registry_1r",registry_1o:"registry_1r",registry_1p:"registry_1r",registry_1r:"registry_1r",
    registry_1h_history:"registry_1r_history",registry_1i_history:"registry_1r_history",registry_1j_history:"registry_1r_history",registry_1k_history:"registry_1r_history",registry_1l_history:"registry_1r_history",registry_1m_history:"registry_1r_history",registry_1n_history:"registry_1r_history",registry_1o_history:"registry_1r_history",registry_1p_history:"registry_1r_history",registry_1r_history:"registry_1r_history",
    clipboard_history_1h:"clipboard_history_1r",clipboard_history_1i:"clipboard_history_1r",clipboard_history_1j:"clipboard_history_1r",clipboard_history_1k:"clipboard_history_1r",clipboard_history_1l:"clipboard_history_1r",clipboard_history_1m:"clipboard_history_1r",clipboard_history_1n:"clipboard_history_1r",clipboard_history_1o:"clipboard_history_1r",clipboard_history_1p:"clipboard_history_1r",clipboard_history_1r:"clipboard_history_1r",
    startup_apps_1h:"startup_apps_1r",startup_apps_1i:"startup_apps_1r",startup_apps_1j:"startup_apps_1r",startup_apps_1k:"startup_apps_1r",startup_apps_1l:"startup_apps_1r",startup_apps_1m:"startup_apps_1r",startup_apps_1n:"startup_apps_1r",startup_apps_1o:"startup_apps_1r",startup_apps_1p:"startup_apps_1r",startup_apps_1r:"startup_apps_1r",
    update_preferences_1k:"update_preferences_1r",update_preferences_1l:"update_preferences_1r",update_preferences_1m:"update_preferences_1r",update_preferences_1n:"update_preferences_1r",update_preferences_1o:"update_preferences_1r",update_preferences_1p:"update_preferences_1r",update_preferences_1r:"update_preferences_1r",
    update_history_1k:"update_history_1r",update_history_1l:"update_history_1r",update_history_1m:"update_history_1r",update_history_1n:"update_history_1r",update_history_1o:"update_history_1r",update_history_1p:"update_history_1r",update_history_1r:"update_history_1r",
    focus_sessions_1k:"focus_sessions_1r",focus_sessions_1l:"focus_sessions_1r",focus_sessions_1m:"focus_sessions_1r",focus_sessions_1n:"focus_sessions_1r",focus_sessions_1o:"focus_sessions_1r",focus_sessions_1p:"focus_sessions_1r",focus_sessions_1r:"focus_sessions_1r",
    feedback_1n:"feedback_1r",feedback_1o:"feedback_1r",feedback_1p:"feedback_1r",feedback_1r:"feedback_1r",routines_1n:"routines_1r",routines_1o:"routines_1r",routines_1p:"routines_1r",routines_1r:"routines_1r",accessibility_1n:"accessibility_1r",accessibility_1o:"accessibility_1r",accessibility_1p:"accessibility_1r",accessibility_1r:"accessibility_1r",welcome_1n_at_login:"home_1r_at_login",home_1o_at_login:"home_1r_at_login",home_1p_at_login:"home_1r_at_login",home_1r_at_login:"home_1r_at_login",notification_preferences_1o:"notification_preferences_1r",notification_preferences_1p:"notification_preferences_1r",notification_preferences_1r:"notification_preferences_1r",session_state_1o:"session_state_1r",session_state_1p:"session_state_1r",session_state_1r:"session_state_1r",account_history_1p:"account_history_1r",account_history_1r:"account_history_1r",game_data_1p:"game_data_1r",game_data_1r:"game_data_1r",calendar_preferences_1p:"calendar_preferences_1r",calendar_preferences_1r:"calendar_preferences_1r"
    ,registry_1q:"registry_1r",registry_1q_history:"registry_1r_history",clipboard_history_1q:"clipboard_history_1r",startup_apps_1q:"startup_apps_1r",update_preferences_1q:"update_preferences_1r",update_history_1q:"update_history_1r",focus_sessions_1q:"focus_sessions_1r",feedback_1q:"feedback_1r",routines_1q:"routines_1r",accessibility_1q:"accessibility_1r",home_1q_at_login:"home_1r_at_login",notification_preferences_1q:"notification_preferences_1r",session_state_1q:"session_state_1r",account_history_1q:"account_history_1r",game_data_1q:"game_data_1r",calendar_preferences_1q:"calendar_preferences_1r"
  };
  const canonical=category=>categoryAliases[category]||category;
  const knownVersions=["1H","1I","1J","1K","1L","1M","1N","1O","1P","1Q","1R"];
  const knownSchemas=new Set([
    ...
    "gold1k-split-v1","gold1k-split-v2","gold1l-split-v1","gold1l-split-v2","gold1m-split-v1","gold1m-split-v2","gold1n-split-v1","gold1n-split-v2","gold1o-split-v1","gold1o-split-v2","gold1p-split-v1","gold1p-split-v2","gold1q-split-v1","gold1q-split-v2","gold1r-split-v1","gold1r-split-v2"
  ]);
  const baseCategories=["file_tombstones","file_system_metadata","files","file_recovery_catalog","folders","tickets","mail","notes","tasks","events","contacts","notifications","user_apps","remote_sessions","emergency_logs","vm_snapshots","custom_app_logos","app_verification_cache","elsus_original_state","elsus_shell_state","sticky_notes","voice_recordings","feedback_1r","routines_1r","accessibility_1r","home_1r_at_login","notification_preferences_1r","session_state_1r","account_history_1r","game_data_1r","calendar_preferences_1r","file_operations_1r"];
  const targetCategories=[...baseCategories,"registry_1r","registry_1r_history","clipboard_history_1r","startup_apps_1r","update_preferences_1r","update_history_1r","focus_sessions_1r","account_history_1r","game_data_1r","calendar_preferences_1r","file_operations_1r"];
  ...
  function localKeyFor(category){
    if(category==="registry_1r")return PREFIX+"registry_1r";
    if(category==="registry_1r_history")return PREFIX+"registry_1r_history";
    if(category==="clipboard_history_1r")return PREFIX+"clipboard_history_1r";
    if(category==="startup_apps_1r")return PREFIX+"startup_apps_1r";
    if(category==="update_preferences_1r")return PREFIX+"update_preferences_1r";
    if(category==="update_history_1r")return PREFIX+"update_history_1r";
    if(category==="focus_sessions_1r")return PREFIX+"focus_sessions_1r";
    if(category==="notification_preferences_1r")return PREFIX+"notification_preferences_1r";
    if(category==="session_state_1r")return PREFIX+"session_state_1r";
    if(category==="account_history_1r")return PREFIX+"account_history_1r";
    if(category==="game_data_1r")return PREFIX+"game_data_1r";
    if(category==="calendar_preferences_1r")return PREFIX+"calendar_preferences_1r";
  ...
  function mergeCategory(category,sources){
    ...
    const arrayCategory=["tickets","notes","tasks","events","contacts","notifications","user_apps","remote_sessions","emergency_logs","vm_snapshots","sticky_notes","voice_recordings","registry_1r_history","clipboard_history_1r","startup_apps_1r","update_history_1r","account_history_1r","file_tombstones","file_recovery_catalog","file_operations_1r"].includes(category);
  ...
  async function collectOrphanedChunks(fb,vmUser=currentUser()){
    ...
    }catch(error){console.debug("Gold 1R orphaned chunk recovery unavailable",error?.message)}
  }
  ...
  async function archiveSourceCategory(fb,version,category,value,vmUser=currentUser()){
    ...
    const id=`${safeVersion}__${category}`,json=JSON.stringify(value??null),base={version:safeVersion,category,updatedAt:now(),source:"Gold 1R pre-migration archive"};
  ...
  async function collectCloudSources(fb){
    ...
    for(const vmUser of userCandidates()){
      ...
      }catch(error){console.debug("Gold 1R VM summary source skipped",vmUser,error?.message)}
      const candidateVersion=String(summary?.version||summary?.activeVersion||"UNKNOWN").toUpperCase();
      if(summary&&!newestSummary){newestSummary=summary;sourceVersion=candidateVersion}if(summary?.savedAt){const prior=Date.parse(window.__GOLD1R_CLOUD_SUMMARY_SAVED_AT__||0)||0;if(Date.parse(summary.savedAt)>prior)window.__GOLD1R_CLOUD_SUMMARY_SAVED_AT__=summary.savedAt}
      if(summary){
        if(summary.openWindows)addSource("session_state_1r",{version:candidateVersion,updatedAt:summary.savedAt||now(),windows:summary.openWindows,openApps:[]},`goldVM/current window summary at ${vmUser}`);
        if(knownSchemas.has(summary.schema)){
          for(const category of summary.categories||[]){
            ...
            }catch(error){console.warn("Gold 1R category migration skipped",category,error)}
          }
        }else{
      ...
      }catch(error){console.debug("Gold 1R category scan unavailable",vmUser,error?.message)}
      ...
      }catch(error){console.debug("Gold 1R version backup scan unavailable",vmUser,error?.message)}
  ...
  function refreshDesktop(){
    try{window.Gold50?.setPrefs?.(read(PREFIX+"prefs",{}));window.Gold50?.saveFiles?.(read(PREFIX+"files",[]));window.Gold50?.renderDesktop?.();window.Gold50?.renderStartMenu?.();window.Gold50?.renderNotificationBadge?.()}catch(error){console.debug("Gold 1R UI refresh after migration skipped",error?.message)}
  }

  function openMigrationCenter(){
    const report=read(REPORT_KEY,{stage:"not run"}),local=read(PREFIX+"migration_1r_local_report",{}),files=read(PREFIX+"files",[]);
  ...
  async function runMigration(show=false){
    if(window.__GOLD1R_MIGRATION_RUNNING__)return window.__GOLD1R_MIGRATION_PROMISE__;
    window.__GOLD1R_MIGRATION_RUNNING__=true;
    sourceMap.clear();collectLocalSources();
    const promise=(async()=>{
      let cloudInfo={summary:null,sourceVersion:"none"},cloudError=null;
      try{const fb=await withTimeout(import("./firebase.js"),20000,"Firebase migration connection timed out");if(fb.db)cloudInfo=await withTimeout(collectCloudSources(fb),30000,"Cloud migration scan timed out");else cloudError="Firebase is not configured"}catch(error){cloudError=error.message;console.warn("Gold 1R cloud migration continued locally",error)}
      ...
      if(cloudTemporarilyUnverified){
        ...
        window.__GOLD1R_MIGRATION_BLOCK_SAVES__=true;window.__GOLD1R_MIGRATION_COMPLETE__=false;
        localStorage.setItem(PREFIX+"cloud_status","migration waiting for cloud verification");
        if(show)window.Gold1R?.notify?.("Cloud migration not verified","Gold 1R kept cloud autosave blocked so older files cannot be overwritten. Reconnect and run the migration scan again.","Migration & Continuity");
        return report;
      }
      report.autosaveUnblockedAt=now();report.autosaveStillBlocked=false;
      write(REPORT_KEY,report);refreshDesktop();
      window.__GOLD1R_MIGRATION_BLOCK_SAVES__=false;window.__GOLD1R_MIGRATION_COMPLETE__=true;
      try{window.__GOLD1R_MIGRATION_COMMITTING__=true;await window.Gold1R?.saveWorkspaceNow?.(false)}catch(error){console.warn("Gold 1R post-migration save deferred",error)}finally{window.__GOLD1R_MIGRATION_COMMITTING__=false}
      const noticeKey=PREFIX+"migration_1r_notice_shown";
      if(show||localStorage.getItem(noticeKey)!=="true"){
        window.Gold1R?.notify?.("Migration complete",`${report.filesAfter||0} files and all available VM categories were merged before cloud autosave was enabled.`,"Migration & Continuity");
        localStorage.setItem(noticeKey,"true");
      }
      return report;
    })().finally(()=>{window.__GOLD1R_MIGRATION_RUNNING__=false});
    window.__GOLD1R_MIGRATION_PROMISE__=promise;return promise;
  }

  function install(){
    registerMigrationApp();
    const api=window.Gold1R||{};api.runMigration=runMigration;api.openMigrationCenter=openMigrationCenter;api.migrationReport=()=>read(REPORT_KEY,null);window.Gold1R=api;
    if(window.Gold50){window.Gold50.openMigrationCenter=openMigrationCenter;window.Gold50.runMigration=runMigration}
    runMigration(false);
    window.addEventListener("online",()=>{if(window.__GOLD1R_MIGRATION_BLOCK_SAVES__===true)setTimeout(()=>runMigration(false),1000)});
    setInterval(()=>{if(window.__GOLD1R_MIGRATION_BLOCK_SAVES__===true&&navigator.onLine)runMigration(false)},60000);
  }
