...
(function(){
  const BUILD = {
    ...
    version: "Gold Release 1.0 Patch 1",
    prefix: "gold10_",
    cloudPath: "gold10"
  };
  ...
  function seedFiles(){return [
    ...
    {id:id(),name:"Welcome to Gold 1.0.txt",type:"text",parent:null,star:true,trash:false,content:"Welcome to EmeraldOS Gold 1.0 Patch 1. This is an independent, lighter Windows 10-inspired EmeraldOS model with its own shell, settings, apps, restore system, and local/cloud workspace.",created:now(),updated:now()},
  ...
  function applyRecommendedGoldSetup(){
    ...
    if($("gold_setup_theme")) $("gold_setup_theme").value="light";
